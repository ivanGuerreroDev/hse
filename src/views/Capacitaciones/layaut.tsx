  ...
  render() {
    return (
      <View style={styles.container}>
        <Header
          containerStyle={{...styles.header, backgroundColor: this.props.Color}}
          leftComponent={
        ...
        {this.props.Footer && (
          <View style={{...styles.footer, backgroundColor: this.props.Color}}>
                ...
                <>
                  ...
                  <View>
                    <Icon
                      ...
                      onPress={() => console.log('hello')}
                    />
                    <Text style={styles.TextIcon}> Firmar</Text>
                  </View>
                </>
              ) : (
                <View>
                  <Icon
                    ...
                    onPress={() => console.log('hello')}
                  />
                  <Text style={styles.TextIcon}> Aceptar</Text>
                </View>
              )}
            </View>
          </View>
