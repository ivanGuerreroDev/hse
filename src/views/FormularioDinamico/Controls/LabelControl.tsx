        ...
        <Text
          ...
          {controlBridge.property('title').includes('Nota')
            ? controlBridge.property('title').split(' ')[1] === '1'
              ? controlBridge.property('title').replace('1', '1,0')
              : controlBridge.property('title').split(' ')[1] === '2'
              ? controlBridge.property('title').replace('2', '2,0')
              : controlBridge.property('title').split(' ')[1] === '3'
              ? controlBridge.property('title').replace('3', '3,0')
              : controlBridge.property('title').split(' ')[1] === '4'
              ? controlBridge.property('title').replace('4', '4,0')
              : controlBridge.property('title').split(' ')[1] === '5'
              ? controlBridge.property('title').replace('5', '5,0')
