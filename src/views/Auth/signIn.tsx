          ...
          resolve();
                ...
                if (signin.AuthenticationResult?.AccessToken) {
                    let accessToken: string =
                        signin.AuthenticationResult.AccessToken;
                    let userData: GetUserCommandOutput = await getUser(
                        accessToken
                    );
            ...
            <Layaut>
                ...
                <View style={styles.containerInput}>
                    <Input
                        ...
                        onBlur={() =>
                            this.setState({ placeholder_emp: '12345678-9' })
                        }
                    ...
                    <Input
                        ...
                        onBlur={() =>
                            this.setState({ placeholder_user: 'Usuario' })
                        }
                    ...
                    <Input
                        ...
                        onBlur={() =>
                            this.setState({ placeholder_pass: 'Contraseña' })
                        }
                ...
                <Text style={this.state.messageStyle}>
