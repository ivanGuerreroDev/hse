import { GEOLOCATION_ACTIONS, NETINFOSTATE_ACTIONS, UpdateGeolocation, UpdateGeolocationAction, UpdateNetInfoState, UpdateNetInfoStateAction } from './types';
...
export const updateGeolocation: UpdateGeolocation = (geolocation: GeolocationResponse): UpdateGeolocationAction => {
