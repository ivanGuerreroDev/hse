...
export default class Gallery extends Component<Props, State> {
    ...
    constructor(props: Props) {
        console.debug('construct Gallery');
        super(props);
                    ...
                    .then((response) => {
                        this.setState({
                            ...
                            selectedItemsCounter:
                                props.selectedItemsUri?.length || 0
                        });
                    })
    ...
    render() {
        console.debug(
            `render Gallery, with ${
                this.state.cachedUris.length + this.state.galleryUris.length
            } media files`
        );
                        ...
                        renderItem={({ item }) => (
                            <GalleryFrame
                                ...
                                onSelect={() => {
                                    ...
                                    this.setState({
                                        selectedItemsCounter:
                                            this.state.selectedItemsCounter + 1
                                    });
                                }}
                                onUnselect={() => {
