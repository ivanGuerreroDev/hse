...
export default class MediaSelector extends Component<Props, State> {
    ...
    constructor(props: Props) {
        console.debug('Construct MediaSelector');
        super(props);
    ...
    addMediaUri(mediaUri: string) {
        ...
        this.setState({
            selectedMediaUris: [...this.state.selectedMediaUris, mediaUri]
        });
    }
    ...
    removeMediaUri(mediaUri: string) {
        ...
        this.setState({
            selectedMediaUris: [
                ...this.state.selectedMediaUris.filter(
                    (uri) => uri !== mediaUri
                )
            ]
        });
    ...
    render() {
        console.debug('Render MediaSelector');
        ...
        if (this.props.showFloatingGallery) {
            showFloatingGallery = (
                <FloatingGallery
                    ...
                    onUnselectMedia={(mediaUri) =>
                        this.removeMediaUri(mediaUri)
                    }
                />
            );
        }
        ...
        const showMode: JSX.Element =
            this.state.showMode === 'camera' ? showCameraMode : showGalleryMode;
