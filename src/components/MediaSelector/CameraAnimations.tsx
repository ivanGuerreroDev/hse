...
export class RecordTimer extends Component<RecordTimerProps> {
  ...
  private animate = Animated.parallel([
    Animated.timing(
      this.state.sizeAnimation.padding,
      {
        toValue: 6,
        duration: 0,
        useNativeDriver: false
    ...
    Animated.timing(
      this.state.sizeAnimation.maxWidth,
      {
        toValue: 80,
        duration: 200,
        useNativeDriver: false
    ...
    Animated.timing(
      this.state.sizeAnimation.maxHeight,
      {
        toValue: 30,
        duration: 200,
        delay: 100,
...
export class GalleryButton extends Component<GalleryButtonProps> {
  ...
  private animate = Animated.parallel([
    Animated.timing(
      this.state.animatedBadge.width,
      {
        toValue: 24,
        duration: 300,
        useNativeDriver: false
    ...
    Animated.timing(
      this.state.animatedBadge.height,
      {
        toValue: 24,
        duration: 300,
        useNativeDriver: false
    ...
    Animated.timing(
      this.state.animatedBadge.borderRadius,
      {
        toValue: 12,
        duration: 300,
        useNativeDriver: false
    ...
    Animated.timing(
      this.state.animatedBadge.bottom,
      {
        toValue: -10,
        duration: 300,
        useNativeDriver: false
    ...
    Animated.timing(
      this.state.animatedBadge.right,
      {
        toValue: -10,
        duration: 300,
        useNativeDriver: false
  ...
  render() {
    return <Animated.View>
      ...
      <Animated.View style={[styles.selectionBadge, this.state.animatedBadge]}>
        <Text style={styles.selectionCounter}>{this.state.count}</Text>
      </Animated.View>
    </Animated.View>
  }
