    ...
    static createFromFormulario(formulario: IFormulario): IDocumento {
        ...
        const currentProfile = store
            ...
            .perfiles.perfiles.filter(
                (item) => item.NombreUsuario === currentUser?.Username
            )[0];
        ...
        return _.cloneDeep({
            ...
            user: currentUser,
            device: {
                applicationBuildNumber: parseInt(
                ...
                availableLocationProviders:
                    deviceInfoModule.getAvailableLocationProvidersSync(),
        ...
        const redundantRegister = (
            ...
            controls
                ...
                .forEach((control) => {
                    ...
                    let bridge: ControlBridge = new ControlBridge(
                        this,
                        control,
                        path
                    );
